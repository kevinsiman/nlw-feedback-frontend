...
export const WidgetSuccess = ({ resetType }: WidgetSuccessProps) => {
  return (
    <>
      ...
      <div className="h-[160px] flex flex-col items-center justify-center gap-3">
        <div className="flex flex-col items-center justify-center gap-1">
          ...
          <span className="text-xl font-semibold">Agradecemos o feedback!</span>
        </div>

        <button
          type="button"
          onClick={resetType}
          className="dark:bg-zinc-800 dark:hover:bg-zinc-700 bg-zinc-100 hover:bg-zinc-200 transition-colors py-2 px-4 rounded-md"
        >
          Quero enviar outro
        </button>
      </div>
